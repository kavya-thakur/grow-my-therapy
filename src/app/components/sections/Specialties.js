...
//     },
//   ];
//   const headline = "Specialized Support";
//   const words = headline.split(" ");

//   return (
//     <section className="pt-10 min-h-screen bg-gradient-to-b from-[var(--color-neutral)] ">
...
//             className="text-sm tracking-[0.3em] text-[var(--color-primary)] mb-6"
//           >
//             AREAS OF FOCUS
//           </motion.p>
...
//               {/* Blur Glass Panel */}
//               <div className="absolute bottom-0 left-0 w-full h-[180px] px-8 pt-10 pb-6 flex flex-col justify-end">
