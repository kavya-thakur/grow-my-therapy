...
const ABOUT_CONTENT = [
  {
    id: 1,
    text: "I’m a licensed clinical psychologist in Santa Monica working with adults navigating anxiety, burnout, and the lingering impact of trauma.",
  },
  {
    id: 2,
    text: (
      <>
        ...
        <strong className="font-medium text-[#1A1A1A]">CBT and EMDR</strong>{" "}
  ...
  {
    id: 3,
    text: "Together, we build steadiness, clarity, and a deeper sense of resilience that extends beyond the therapy room.",
  },
];
...
const imageTransition = { duration: 1, ease: [0.215, 0.61, 0.355, 1] };
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mt-10">
            <button className="group relative cursor-pointer inline-flex items-center gap-4 text-[11px] tracking-[0.2em] font-semibold text-[#1A1A1A]">
